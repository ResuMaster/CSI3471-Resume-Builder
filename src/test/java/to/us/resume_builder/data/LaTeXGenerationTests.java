...
public class LaTeXGenerationTests {
    /**
     * Source method for tests on a {@link to.us.resume_builder.data.resume_components.Bullet}
     * @return a Stream of arguments holding what the internal text is and what the generated LaTex should be
     */
    ...
    /**
     * Source method for tests on a {@link to.us.resume_builder.data.resume_components.Experience}
     * @return a Stream of arguments holding what the internal text is and what the generated LaTex should be
     */
    ...
    /**
     * Source method for tests on a {@link to.us.resume_builder.data.resume_components.category.Category}
     * @return a Stream of arguments holding what the internal text is and what the generated LaTex should be
     */
    ...
    /**
     * Sets up 3 different experiences with different text and visibility options
     * @param c the {@link ExperienceCategory} to add the {@link Experience}s to
     */
    ...
    /**
     * Generates a {@link Resume} to be tested on
     * @return a {@link Resume} with filled in information for each {@link CategoryType}
     */
    ...
    /**
     * Tests the LaTeX generation for a {@link to.us.resume_builder.data.resume_components.Bullet}
     *
     * @param text the text in the {@link to.us.resume_builder.data.resume_components.Bullet}
     * @param expectedLaTeX the expected LaTeX to be generated given the text
     */
    @ParameterizedTest
    @DisplayName("Bullets")
    ...
    /**
     * Tests the LaTeX generation for an {@link Experience}
     *
     * @param title the title for the {@link Experience}
     * @param org the organization for the {@link Experience}
     * @param date the date for the {@link Experience}
     * @param loc the location for the {@link Experience}
     * @param expectedWithoutBullets the expected LaTeX string for an {@link Experience} without {@link to.us.resume_builder.data.resume_components.Bullet}s
     * @param expectedWithBullets the expected LaTeX string for an {@link Experience} with {@link to.us.resume_builder.data.resume_components.Bullet}s
     */
    @ParameterizedTest
    ...
    /**
     * Tests the LaTeX generation for a {@link BulletCategory}
     *
     * @param name the given name for the {@link BulletCategory}
     * @param displayName the display name for the {@link BulletCategory}
     * @param expectedCategoryStuff the LaTeX which should be generated by the {@link BulletCategory}
     */
    @ParameterizedTest
    ...
    /**
     * Tests the LaTeX generation for an {@link ExperienceCategory}
     *
     * @param name the given name for the {@link ExperienceCategory}
     * @param displayName the display name for the {@link ExperienceCategory}
     * @param expectedCategoryStuff the LaTeX which should be generated by the {@link ExperienceCategory}
     */
    @ParameterizedTest
    ...
    /**
     * Tests the LaTeX generation for a {@link TextCategory}
     *
     * @param name the given name for the {@link TextCategory}
     * @param displayName the display name for the {@link TextCategory}
     * @param expectedCategoryStuff the LaTeX which should be generated by the {@link TextCategory}
     */
    @ParameterizedTest
    ...
    /**
     * Tests the LaTeX generation for a {@link HeaderCategory}
     *
     * @param name the given name for the {@link HeaderCategory}
     * @param displayName the display name for the {@link HeaderCategory}
     * @param expectedCategoryStuff the LaTeX which should be generated by the {@link HeaderCategory}
     */
    @ParameterizedTest
    ...
    /**
     * Tests with an entire {@link Resume} in LaTeX form and verifies it is equal to the LaTeX generated
     */
    @Test
